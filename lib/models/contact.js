 ...
 * @params {Number} responseTime - Milliseconds of the response time
 */
ContactSchema.methods.recordResponseTime = function(responseTime) {
  ...
  // The number of requests used in calculating the average
  const p = 1000;

  const lastResponseTime = this.responseTime || 0;
