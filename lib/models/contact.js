...
const MAX_REPUTATION_POINTS = 5000;
const MIN_REPUTATION_POINTS = 0;
 ...
 */
ContactSchema.methods.recordReputionPoints = function(points) {
  ...
  if (newPoints >= MAX_REPUTATION_POINTS) {
    newPoints = MAX_SUCCESS;
  } else if (newPoints <= MIN_REPUTATION_POINTS) {
    newPoints = MIN_SUCCESS;
  }
  this.reputation = newSuccessRate;
