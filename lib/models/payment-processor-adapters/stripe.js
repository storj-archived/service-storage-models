...
const stripeAdapter = {
   ...
   */
  parseData: function() {
    return stripeProcessor.rawData[0] || {};
  },
  /**
      ...
      stripe.customers.createSource(
        ...
        function(err) {
          ...
          stripe.customers.retrieve(customerId, function(err, customer) {
            ...
            return resolve(stripeProcessor.save());
          });
  ...
  paymentMethods: function() {
    ...
    return !!stripeProcessor.data.customer ?
        stripeProcessor.data.customer.sources.data : null
  }
