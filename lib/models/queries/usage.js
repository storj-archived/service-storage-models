...
const calculateTimeRangeIntersectionLength = function(startTimeOne, endTimeOne, startTimeTwo, endTimeTwo) {
...
const calculateUserAmountOwedForStorage = function(userId, billingPeriodStart, billingPeriodEnd, gbHourPrice) {
...
const calculateUserAmountOwedForBandwidth = function(userId, billingPeriodStart, billingPeriodEnd, perGbPrice) {
  var userPublicKeys = [];
...
module.exports = {
  amountOwedForBandwidth: calculateUserAmountOwedForBandwidth,
  amountOwedForStorage: calculateUserAmountOwedForStorage
};
